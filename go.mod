module github.com/go-dyn

replace github.com/go-dyn/attachment v0.0.0 => ./packages/attachment

replace github.com/go-dyn/blog v0.0.0 => ./packages/blog
...
require (
	github.com/go-dyn/attachment v0.0.0
	github.com/go-dyn/blog v0.0.0
